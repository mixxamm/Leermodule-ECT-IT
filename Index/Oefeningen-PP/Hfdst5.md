...
- [BMI met if](./Hfdst5/BMI_met_if.md)
- [Schoenverkoper](./Hfdst5/Schoenverkoper.md)
...
- [Quiz](./Hfdst5/Quiz.md)
- [Schrikkeljaar](./Hfdst5/Schrikkeljaar.md)
- [GunterD Stemwijzer](./Hfdst5/GuntherD_Stemwijzer.md)
- [Enum seizoenen](./Hfdst5/Enum_seizoenen.md)
- [Enum bij BMI](./Hfdst5/Enum_bij_BMI.md)
- [Kleurcode weerstand naar ohm, met enum](./Hfdst5/Kleurcode_weerstand_naar_ohm,_met_enum.md)
